import { Phone, ArrowRight, Car, Snowflake, Leaf, Trash2, Clock, Star, Sparkles, Heart, MapPin, Wrench } from 'lucide-react';
...
function Hero() {
  ...
  return (
    <section className="relative flex min-h-screen items-center overflow-hidden">
      {/* Premium branded static background */}
      <div className="absolute inset-0 bg-ink-950">
        {/* Subtle metallic grid texture */}
        <div className="absolute inset-0 bg-grid opacity-40" />
        {/* Red glow — upper right, matches logo red */}
        <div className="absolute -right-24 -top-24 h-[36rem] w-[36rem] rounded-full bg-brand-600/20 blur-[120px]" />
        {/* Red glow — lower left, softer */}
        <div className="absolute -bottom-32 -left-28 h-[32rem] w-[32rem] rounded-full bg-brand-700/12 blur-[140px]" />
        {/* Silver metallic diagonal sheen */}
        <div className="absolute inset-0 bg-gradient-to-br from-white/[0.03] via-transparent to-silver-300/[0.05]" />
        {/* Faint abstract concentric rings — automotive detail feel */}
        <div className="absolute right-0 top-1/3 h-[30rem] w-[30rem] rounded-full border border-silver-400/[0.06]" />
        <div className="absolute right-10 top-1/4 h-[22rem] w-[22rem] rounded-full border border-silver-400/[0.04]" />
        <div className="absolute right-24 top-[18%] h-[14rem] w-[14rem] rounded-full border border-silver-400/[0.03]" />
      </div>
