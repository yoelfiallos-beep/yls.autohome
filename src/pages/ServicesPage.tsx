      ...
      <section className="section-pad pt-0" id="see-the-difference">
        <div className="container-x">
          <SectionHeading
            ...
            title={<>Watch us work</>}
            subtitle="Take a look at some of our recent auto detailing work."
          />
          <div className="mx-auto mt-12 flex max-w-4xl flex-col gap-6">
            {[
              '/videos/hero-video.mp4',
              '/videos/detailing-work.mp4',
              '/videos/interior-result.mp4',
            ].map((src, i) => (
              <div
                key={src}
                className="reveal group relative aspect-video w-full overflow-hidden rounded-2xl border border-silver-400/15 bg-ink-900 shadow-lg shadow-black/30"
